...
#write10xCounts(x = data@assays$RNA@counts, path = "/projects/cangen/coliveir/Miguel/output/10x/metacell_SCT/data")
...
if(!dir.exists("/projects/cangen/coliveir/Miguel/output/10x/metacell_SCT/db")) dir.create("/projects/cangen/coliveir/Miguel/output/10x/metacell_SCT/db")
scdb_init("/projects/cangen/coliveir/Miguel/output/10x/metacell_SCT/db", force_reinit=T)

mcell_import_scmat_10x("test1", base_dir="/projects/cangen/coliveir/Miguel/output/10x/metacell_SCT/data")

mat = scdb_mat("test1")

if(!dir.exists("/projects/cangen/coliveir/Miguel/output/10x/metacell_SCT/figs")) dir.create("/projects/cangen/coliveir/Miguel/output/10x/metacell_SCT/figs")
scfigs_init("/projects/cangen/coliveir/Miguel/output/10x/metacell_SCT/figs")
...
library(gridExtra)
png("/projects/cangen/coliveir/Miguel/Figures/Metacell_SCT_Markers.png", width=10, height=8, res = 500, units = "in")
