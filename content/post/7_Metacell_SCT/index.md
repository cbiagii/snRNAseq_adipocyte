...
write10xCounts(x = data@assays$RNA@counts, path = "/Users/biagi/PhD/Adipocyte/output/10x/metacell_SCT/data")


## Initializing a database
if(!dir.exists("/Users/biagi/PhD/Adipocyte/output/10x/metacell_SCT/db")) dir.create("/Users/biagi/PhD/Adipocyte/output/10x/metacell_SCT/db")
scdb_init("/Users/biagi/PhD/Adipocyte/output/10x/metacell_SCT/db", force_reinit = TRUE)

## Loading the data generated by the 10x conversion above
mcell_import_scmat_10x("test1", base_dir = "/Users/biagi/PhD/Adipocyte/output/10x/metacell_SCT/data")
mat <- scdb_mat("test1")

## Linking to a figure directory
if(!dir.exists("/Users/biagi/PhD/Adipocyte/output/10x/metacell_SCT/figs")) dir.create("/Users/biagi/PhD/Adipocyte/output/10x/metacell_SCT/figs")
scfigs_init("/Users/biagi/PhD/Adipocyte/output/10x/metacell_SCT/figs")
