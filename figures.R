...
postscript("/projects/cangen/coliveir/Miguel/paper/Figure_1B_1.eps", width = 7, height = 6)
...
postscript("/projects/cangen/coliveir/Miguel/paper/Figure_1B_2.eps", width = 7, height = 7)
print(pt)
dev.off()
...
postscript("/projects/cangen/coliveir/Miguel/paper/Figure_1C_1.eps", width = 8, height = 6)
print(ht1)
dev.off()

tiff("/projects/cangen/coliveir/Miguel/paper/Figure_1C_2.tiff", width = 8, height = 6, units = 'in', res = 600)
print(ht2)
dev.off()
...
load("/Users/biagi/cangen/coliveir/Miguel/output/10x/metacell/db/mc2d.test_2dproj.Rda")
dims <- data.frame(x = object@sc_x,
                   y = object@sc_y)

load("/Users/biagi/cangen/coliveir/Miguel/output/10x/metacell/db/mc.test_mc_f.Rda")
tmp1 <- data.frame(cells = names(object@mc), cols = object@mc)
tmp2 <- data.frame(cols = object@colors)
teste <- merge(tmp1, tmp2, by.x = "cols", by.y = "row.names")
teste$cols <- NULL
...
data <- readRDS("/Users/biagi/cangen/coliveir/Miguel/output/10x/10x_SCT_Processed_ALRA.rds")
...
postscript("/projects/cangen/coliveir/Miguel/paper/Figure_1D_1.eps", width = 10, height = 8)
...
postscript("/projects/cangen/coliveir/Miguel/paper/Figure_1D_2.eps", width = 5, height = 4)
print(pt[[1]])
dev.off()

postscript("/projects/cangen/coliveir/Miguel/paper/Figure_1D_3.eps", width = 5, height = 4)
print(pt[[2]])
dev.off()

postscript("/projects/cangen/coliveir/Miguel/paper/Figure_1D_4.eps", width = 5, height = 4)
print(pt[[3]])
dev.off()

postscript("/projects/cangen/coliveir/Miguel/paper/Figure_1D_5.eps", width = 5, height = 4)
print(pt[[4]])
dev.off()
...
paths <- paths[which(paths$Term %in% c("PPAR signaling pathway", "AMPK signaling pathway", "Fatty acid biosynthesis", "Focal adhesion",
                                       "ECM-receptor interaction", "Cell adhesion molecules (CAMs)", "Adherens junction", "3T3-L1 cell",
                                       "Abdominal adipose tissue", "Subcutaneous adipose tissue", "Vasculature", "Umbilical vein",
                                       "Vascular cell", "Common cardinal vein", "Mesenchyme", "triglyceride biosynthetic process",
...
postscript("/projects/cangen/coliveir/Miguel/paper/Figure_1E.eps", width = 8, height = 6)
print(pt)
dev.off()
...
postscript("/projects/cangen/coliveir/Miguel/paper/Figure_2A.eps", width = 7, height = 6)
...
postscript("/projects/cangen/coliveir/Miguel/paper/Figure_2B_1.eps", width = 8, height = 6)
print(ht1)
dev.off()

tiff("/projects/cangen/coliveir/Miguel/paper/Figure_2B_2.tiff", width = 8, height = 6, units = 'in', res = 600)
print(ht2)
dev.off()
...
postscript("/Users/biagi/cangen/coliveir/Miguel/paper/Figure_2C.eps", width = 8, height = 6)
...
paths <- paths[which(paths$Term %in% c("PPAR signaling pathway", "Fatty acid degradation", "Glyoxylate and dicarboxylate metabolism",
                                       "Insulin resistance", "Biosynthesis of unsaturated fatty acids", "Fatty acid biosynthesis",
                                       "Adipocytokine signaling pathway", "Propanoate metabolism", "IL-17 signaling pathway",
                                       "Fat digestion and absorption", "Mitochondrial Gene Expression WP1263", "Fatty acid oxidation WP2318",
                                       "Fatty Acid Biosynthesis WP336", "TCA Cycle WP434", "Cholesterol metabolism WP4346",
                                       "Subcutaneous adipose tissue", "3T3-L1 cell", "triglyceride biosynthetic process",
                                       "triglyceride metabolic process", "long-chain fatty acid transport", "neutral amino acid transport",
                                       "regulation of sequestering of triglyceride", "cardiolipin acyl-chain remodeling",
                                       "acylglycerol acyl-chain remodeling", "adipose brown")), ]
...
postscript("/projects/cangen/coliveir/Miguel/paper/Figure_2D.eps", width = 8, height = 6)
print(pt)
dev.off()
...
pt1 <- ggboxplot(df, x = "cluster", y = "value",
...
postscript("/Users/biagi/cangen/coliveir/Miguel/paper/Figure_2E.eps", width = 9, height = 7)
print(pt1)
dev.off()
...
postscript("/Users/biagi/cangen/coliveir/Miguel/paper/Figure_3A.eps", width = 7, height = 6)
...
postscript("/Users/biagi/cangen/coliveir/Miguel/paper/Figure_3B.eps", width = 9, height = 6)
...
#ColdxRT
comp1 <- read.table("/Users/biagi/cangen/coliveir/Miguel/Figures/update/Diff_Adipocytes_ColdxRT_ALL.txt")
...
#write.table(fgseaRes1, '/projects/cangen/coliveir/Miguel/Figures/update/fgsea_ColdxRT.txt', row.names = F, col.names = T, sep = '\t', quote = F)
enrich_ColdxRT <- read.table('/Users/biagi/cangen/coliveir/Miguel/Figures/update/fgsea_ColdxRT.txt', header = T)
...
pt1 <- ggplot(enrich_ColdxRT, aes(order, NES, fill = class)) +
...
postscript("/Users/biagi/cangen/coliveir/Miguel/paper/Figure_3D_1.eps", width = 8, height = 6)
...
#CLxRT
comp2 <- read.table("/Users/biagi/cangen/coliveir/Miguel/Figures/update/Diff_Adipocytes_CLxRT_ALL.txt")
...
#write.table(fgseaRes2, '/projects/cangen/coliveir/Miguel/Figures/update/fgsea_CLxRT.txt', row.names = F, col.names = T, sep = '\t', quote = F)
enrich_CLxRT <- read.table('/Users/biagi//cangen/coliveir/Miguel/Figures/update/fgsea_CLxRT.txt', header = T)
...
pt2 <- ggplot(enrich_CLxRT, aes(order, NES, fill = class)) +
  geom_bar(stat = "identity", show.legend = TRUE) +
  xlab(NULL) + ylab("Normalized Enrichment Score (NES)") +
  theme_bw() +
  coord_flip() +
...
postscript("/Users/biagi/cangen/coliveir/Miguel/paper/Figure_3D_2.eps", width = 8, height = 6)
pt2 + theme(legend.position = "right",
            axis.title = element_blank(),
            axis.text = element_blank(),
            panel.background = element_blank())
dev.off()
...
#mks_ColdxRT <- subset(markers_ColdxRT, p_val_adj < 0.01)
#mks_ColdxRT <- mks_ColdxRT[order(mks_ColdxRT$p_val_adj), ]
#upGenes <- head(subset(mks_ColdxRT, avg_logFC > 0)$gene, 50)
#downGenes <- head(subset(mks_ColdxRT, avg_logFC < 0)$gene, 50)
#pt_ColdxRT <- volcano.plot(res = markers_ColdxRT, upGenes = upGenes, downGenes = downGenes) + ggtitle("Cold x RT") + theme(plot.title = element_text(hjust = 0.5))
#write.table(c(upGenes, downGenes), "/projects/cangen/coliveir/Miguel/Figures/update/Diff_Adipocytes_ColdxRT.txt", row.names = F, col.names = F, quote = F, sep = "\t")
#
#markers_CLxRT <- FindMarkers(data, ident.1 = "CL", ident.2 = "RT", logfc.threshold = 0)
#markers_CLxRT$gene <- rownames(markers_CLxRT)
#mks_CLxRT <- subset(markers_CLxRT, p_val_adj < 0.01)
#mks_CLxRT <- mks_CLxRT[order(mks_CLxRT$p_val_adj), ]
#upGenes <- head(subset(mks_CLxRT, avg_logFC > 0)$gene, 50)
#downGenes <- head(subset(mks_CLxRT, avg_logFC < 0)$gene, 50)
#pt_CLxRT <- volcano.plot(res = markers_CLxRT, upGenes = upGenes, downGenes = downGenes) + ggtitle("CL x RT") + theme(plot.title = element_text(hjust = 0.5))
#write.table(c(upGenes, downGenes), "/projects/cangen/coliveir/Miguel/Figures/update/Diff_Adipocytes_CLxRT.txt", row.names = F, col.names = F, quote = F, sep = "\t")
#
#postscript("/Users/biagi/cangen/coliveir/Miguel/paper/Figure_3C.eps", width = 8, height = 6)
#ggarrange(pt_ColdxRT, pt_CLxRT)
#dev.off()
...
pie_CL <- ggplot(df2, aes(x = "", y = value, fill = class)) +
  geom_bar(width = 1, stat = "identity", color = "white") +
  coord_polar("y", start = 0)+
...
postscript("/Users/biagi/cangen/coliveir/Miguel/paper/Figure_3E_1_1.eps", width = 7, height = 6)
print(cond_CL)
dev.off()
postscript("/Users/biagi/cangen/coliveir/Miguel/paper/Figure_3E_1_2.eps", width = 7, height = 6)
print(pie_CL)
dev.off()
...
pie_RT <- ggplot(df2, aes(x = "", y = value, fill = class)) +
  geom_bar(width = 1, stat = "identity", color = "white") +
  coord_polar("y", start = 0)+
  scale_fill_manual(values = c("#11c78b", "#800080", "#e57400", "#0000FF", "#dfdf0d")) +
  theme_void() + labs(fill = "Clusters") +
...
postscript("/Users/biagi/cangen/coliveir/Miguel/paper/Figure_3E_2_1.eps", width = 7, height = 6)
print(cond_RT)
dev.off()
postscript("/Users/biagi/cangen/coliveir/Miguel/paper/Figure_3E_2_2.eps", width = 7, height = 6)
print(pie_RT)
dev.off()
...
pie_4day <- ggplot(df2, aes(x = "", y = value, fill = class)) +
  geom_bar(width = 1, stat = "identity", color = "white") +
  coord_polar("y", start = 0)+
  scale_fill_manual(values = c("#11c78b", "#800080", "#e57400", "#0000FF", "#dfdf0d")) +
  theme_void() + labs(fill = "Clusters") +
...
postscript("/Users/biagi/cangen/coliveir/Miguel/paper/Figure_3E_3_1.eps", width = 7, height = 6)
print(cond_Cold)
dev.off()
postscript("/Users/biagi/cangen/coliveir/Miguel/paper/Figure_3E_3_2.eps", width = 7, height = 6)
print(pie_4day)
dev.off()
...
#5)Triglyceride/Fatty Acid Cycle
...
postscript("/Users/biagi/cangen/coliveir/Miguel/paper/Figure_3G_1.eps", width = 8, height = 6)
print(ht1)
dev.off()

tiff("/Users/biagi/cangen/coliveir/Miguel/paper/Figure_3G_2.tiff", width = 8, height = 6, units = 'in', res = 600)
print(ht2)
dev.off()
...
postscript("/Users/biagi/cangen/coliveir/Miguel/paper/Figure_3F.eps", width = 9, height = 7)
print(pt1)
dev.off()
...
postscript("/Users/biagi/cangen/coliveir/Miguel/paper/Figure_3H_1.eps", width = 8, height = 6)
plot_cell_trajectory(cds, color_by = "Pseudotime")
dev.off()

postscript("/Users/biagi/cangen/coliveir/Miguel/paper/Figure_3H_2.eps", width = 8, height = 6)
plot_cell_trajectory(cds, color_by = "cluster") + 
  scale_color_manual(values = c("Ad1" = "#11c78b", "Ad2" = "#800080", "Ad3" = "#e57400", "Ad4" = "#0000FF", "Ad5" = "#dfdf0d"))
dev.off()

source('/Users/biagi/cangen/coliveir/plotMonocle.R')
postscript("/Users/biagi/cangen/coliveir/Miguel/paper/Figure_3H_3.eps", width = 8, height = 15)
print(plotMonocle(cds, c('Pparg', 'Creb1', 'Atf2', 'Egr2', 'Dbp', 'Xbp1', 'Clock', 'Zbtb43', 'Zbtb7a')))
dev.off()
...
postscript("/Users/biagi/cangen/coliveir/Miguel/paper/Figure_3H_4.eps", width = 8, height = 6)
plot_cell_trajectory(cds, color_by = "Pseudotime")
dev.off()

postscript("/Users/biagi/cangen/coliveir/Miguel/paper/Figure_3H_5.eps", width = 8, height = 6)
plot_cell_trajectory(cds, color_by = "cluster") + 
  scale_color_manual(values = c("Ad1" = "#11c78b", "Ad2" = "#800080", "Ad3" = "#e57400", "Ad4" = "#0000FF", "Ad5" = "#dfdf0d"))
dev.off()

source('/Users/biagi/cangen/coliveir/plotMonocle.R')
postscript("/Users/biagi/cangen/coliveir/Miguel/paper/Figure_3H_6.eps", width = 8, height = 15)
print(plotMonocle(cds, c('Pparg', 'Creb1', 'Atf2', 'Srebf1', 'Cebpa', 'Egr1', 'Foxn3', 'Esrra', 'Gtf2ird1')))
dev.off()
