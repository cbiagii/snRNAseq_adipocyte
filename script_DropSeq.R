...
data <- Read10X("/projects/cangen/coliveir/Miguel/data/DropSeq")
anno <- read.table("/projects/cangen/coliveir/Miguel/data/DropSeqSVF.metaData.tsv")
...
saveRDS(data, "/projects/cangen/coliveir/Miguel/output/SVF/DropSeq_Processed.rds")
...
data <- readRDS("/projects/cangen/coliveir/Miguel/output/SVF/DropSeq_Processed.rds")

png("/projects/cangen/coliveir/Miguel/output/tSNE_ClassicalMarkers_SVF.png", width=12, height=9, res = 500, units = "in")
FeaturePlot(data, c("Fabp4", "Aqp1", "Cd36"), cols = c("grey", 'red'), reduction = 'tsne')
dev.off()